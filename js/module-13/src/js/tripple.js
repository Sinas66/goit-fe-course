/*
РЎРєСЂРёРїС‚ move (РїРµСЂРµРјРµС‰РµРЅРёРµ): 11.12.2014
РђРІС‚РѕСЂ: РђР»РµРєСЃРµР№ РљРѕРЅР°РЅ
Р”РѕРєСѓРјРµРЅС‚Р°С†РёСЏ: http://akonan.ru/?id=24
*/
...
konan.Move = function(id) {
  ...
  for (var n in konan.move)
    if (konan.move[n].element == e) return konan.move[n];
  konan.move.push(t);
  t.dt = 40;
  t.v = t.a = 0;
  t.position = e.currentStyle
    ? e.currentStyle["position"]
    : window.getComputedStyle(e, "").getPropertyValue("position");
  t.margin = function() {
    var l = e.currentStyle
      ? e.currentStyle["marginLeft"]
      : window.getComputedStyle(e, "").getPropertyValue("margin-left");
    var t = e.currentStyle
      ? e.currentStyle["marginTop"]
  ...
  t.padding = function() {
    ...
    var l = p.currentStyle
      ? p.currentStyle["paddingLeft"]
      : window.getComputedStyle(p, "").getPropertyValue("padding-left");
    var t = p.currentStyle
      ? p.currentStyle["paddingTop"]
      : window.getComputedStyle(p, "").getPropertyValue("padding-top");
    l = isNaN(parseInt(l)) ? 0 : parseInt(l);
    t = isNaN(parseInt(t)) ? 0 : parseInt(t);
    return { left: l, top: t };
  };
